        ...
        if st.button("🔍 بدء التحليل العميق"):
            with st.spinner('جاري فحص الأنماط واستخلاص الخواص...'):
                ...
                if model is not None:
                    ...
                    # --- المسار الأول: حالات السرطان (عتبة مخصصة 58%) ---
                    if label in cancer_info and confidence >= 0.58:
                        ...
                        st.markdown("> **توصية:** تم رصد مؤشرات تتجاوز عتبة الأمان (58%). يرجى مراجعة طبيب اختصاصي فوراً.")

                    # --- المسار الثاني: الحالات الحميدة أو التي لم تصل للعتبة ---
                    else:
                        ...
                        st.balloons()
                        st.markdown("> **توصية:** الخصائص المرصودة تندرج ضمن النطاق الآمن. يُنصح بالمتابعة العادية.")
