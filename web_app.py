        ...
        if st.button("🚀 تحليل الحالة"):
            with st.spinner('جاري الفحص باستخدام الذكاء الاصطناعي...'):
                try:
                    ...
                    # ---------------------------------------------------------
                    # --- [هام جداً]: تحديث أرقام الأمراض الخبيثة بناءً على طلبك ---
                    # ---------------------------------------------------------
                    # تأكد من إضافة كافة الأرقام التي تمثل سرطان (bcc, mel, akiec...)
                    # بناءً على الرقم الذي يظهر في "الرقم: X" عند تشغيل صور خبيثة
                    malignant_indices = [0, 1, 4, 23] 
                    benign_indices = [2, 5] 
                    # ---------------------------------------------------------
                    ...
                    if max_idx in malignant_indices:
                        ...
                        # هذه هي خانة "غير ذلك" للأمراض الجلدية الأخرى
