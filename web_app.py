...
LANG_DATA = {
    ...
    "Polski": {"dir": "ltr", "title": "System AI Skóry", "note": "⚠️ Użyj światła dziennego.", "upload": "📥 Prześlij", "camera": "📸 Kamera", "analyze": "🚀 Analiza", "guide": "📚 Przewodnik", "malig": "🔴 Złośliwe", "benign": "🟢 Łagodne", "res_m": "🚨 Podejrzenie", "res_b": "🔍 Łagodne", "res_g": "🩺 Inne typy", "advice": "Skonsultuj się.", "cause": "Przyczyna", "lang_btn": "🌐 Język", "ref_btn": "🔗 Referencje"},
...
if file:
    ...
    if st.button(t['analyze']):
        with st.spinner("🚀 جاري فحص الصورة..."):
            ...
            # التصنيف المباشر
            if idx in [0, 1, 4]: # الخبيث
                res_msg, color = t['res_m'], "#cf1322"
            elif idx in [2, 3, 5, 6]: # الحميد
                res_msg, color = t['res_b'], "#389e0d"
            else: # غير ذلك (حب شباب، التهابات...)
