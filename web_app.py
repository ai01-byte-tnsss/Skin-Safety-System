        ...
        if st.button("🚀 تحليل الحالة"):
            with st.spinner('جاري الفحص باستخدام الذكاء الاصطناعي...'):
                try:
                    ...
                    # ---------------------------------------------------------
                    # --- [هام]: هذا هو الجزء الذي تم تعديله للخبيث ---
                    # ---------------------------------------------------------
                    # قم بتحديث هذه الأرقام بناءً على الرقم الذي يظهر لك عند التشغيل
                    malignant_indices = [0, 1, 4]  # تم إضافة 0 (akiec) كونه خبيث أيضاً
